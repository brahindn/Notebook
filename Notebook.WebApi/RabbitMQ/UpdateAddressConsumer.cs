...
{
    public class UpdateAddressConsumer: IHostedService, IDisposable
    {
        ...
        public UpdateAddressConsumer(IServiceScopeFactory serviceScopeFactory, RabbitMqSettings rabbitMqSettings)
        {
